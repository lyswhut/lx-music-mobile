...
let lastCommentInfo = { songId: 0, commentId: '' }

export default {
  _requestObj: null,
  _requestObj2: null,
  lastCommentId: new Map(),
  ...
  async getComment(mInfo, page = 1, limit = 20) {
    ...
    if (lastCommentInfo.id != songId) lastCommentInfo = { id: songId, commentId: '' }
      ...
      body: {
        ...
        req: {
          ...
          param: {
            BizType: 1,
            BizId: String(songId),
            LastCommentSeqNo: lastCommentInfo.commentId,
            PageSize: limit,
            PageNum: page - 1,
            WithHot: 0,
            PicEnable: 1,
