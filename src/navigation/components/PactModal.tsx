  ...
  return (
    <View style={styles.main}>
      ...
      <ScrollView style={styles.content} keyboardShouldPersistTaps={'always'}>
        ...
        <Text selectable style={styles.text} >1.3 本项目内置的“试听接口”源的工作原理是尝试直接从对应官方平台公开服务器获取音频连接（与未登录状态在官方平台APP获取的歌曲链接相同），所以若某首歌若无法在处于未登录状态的官方平台APP播放，则理论上“试听接口”源也无法播放该歌曲。</Text>
